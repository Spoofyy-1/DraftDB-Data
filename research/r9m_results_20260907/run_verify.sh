...
out="$base/r9m_verification/results"
mkdir -p "$out"
...
--ro-bind /home/ubuntu/nba/.venv /opt/venv --ro-bind "$base/r9m" /workspace
--ro-bind "$base/r9m_verification/code" /auditcode --bind "$out" /verification
