    ...
    try:
        ...
        if os.path.exists(frozen_test):
            ...
            s['test_result']={
                ...
                'title':'Frozen H model · 2019–2025 reused benchmark',
                'description':'Fixed model recipe and three seeds. Predictions for all seven classes were frozen before scoring. Full pool uses the original benchmark treatment of missing outcomes; the complete-target subset is shown separately. Training labels obey each cutoff; 2024 and 2025 use verified labels only through 2022. The original player pool and retrospective source coverage remain incomplete.',
