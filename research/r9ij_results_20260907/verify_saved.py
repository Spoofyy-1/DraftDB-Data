...
expected=({f"{v['id']}_seed{s}" for v in p['variants'] for s in p['seeds']} if NAME=='r9i' else {f"{t['variant']}_seed{t['seed']}" for t in p['tasks']});assert len(expected)==(336 if NAME=='r9i' else 48)
