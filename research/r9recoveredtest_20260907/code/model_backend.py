"""Pinned K constructors; The recovered adapter uses only TabICL, Ridge and residual q25 XGB."""
...
class Backend:
 ...
 def constructor(self,family,seed):
  if family=='tabicl':
   ...
   import inspect
   assert inspect.signature(TabICLRegressor.__init__).parameters['random_state'].default==42
