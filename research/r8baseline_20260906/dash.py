...
def research_state():
    ...
    try:
        ...
        for record in s.get('candidates',[]):
            ...
            if 'permuted' in record.get('config',{}).get('arms',[]):continue
        ...
        s['research_notice']='270 feature/combinations runs completed. Empty columns reproduced most apparent gains; matched-column checks are required before declaring winners.'
