...
rows=[]; report=[]
for y,d in [(yy,DRAFT[yy]) for yy in (2016,2017,2019,2020,2021,2022,2024)]:
...
w=csv.DictWriter(open("mock_consensus2_ranks_d.csv","w"),fieldnames=["pid","draft_year","site","rank","ts"]); w.writeheader(); [w.writerow(r) for r in rows]
